...
아래는 [glMatrix](http://glmatrix.net/) 라이브러리를 활용하여 벡터와 행렬 연산을 수행하는 예제 코드이다.
...
](https://www.perplexity.ai/search/md-eoneoeseo-haengryeoli-naodo-2zWLFo0cRZiitPtTd9dxtA#1)
